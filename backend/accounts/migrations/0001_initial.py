    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('sales_executive', 'Sales Executive'), ('senior_sales', 'Senior Sales Executive'), ('team_lead', 'Team Lead'), ('manager', 'Manager'), ('admin', 'Admin')], default='sales_executive', max_length=50)),
